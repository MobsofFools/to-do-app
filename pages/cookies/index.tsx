...
const CookiePolicy:NextPage = () => {
  return (
    <Container>
      <h1>Cookie Policy for To Do App</h1>

      <p>
        This is the Cookie Policy for To Do App, accessible from
        portfolio-todo-2022.web.app
      </p>
      ...
      <ul>
        <li>Email: edvinlinbusiness@gmail.com</li>
      </ul>
    </Container>
  );
};
